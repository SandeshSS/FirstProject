...
namespace Tesco.OnlineRetail.UI.MVC.App_Start
{
    ...
    public class NinjectDependencyResolver : IDependencyResolver
    {
        ...
        private void BindDependencies()
        {
            ...
            kernel.Bind<IGiftProductManager>().To<GiftProductManager>();
            kernel.Bind<IGiftProductCategoryManager>().To<GiftProductCategoryManager>();
            kernel.Bind<IClubCardRegManager>().To<ClubCardRegManager>();
        }
    }
}